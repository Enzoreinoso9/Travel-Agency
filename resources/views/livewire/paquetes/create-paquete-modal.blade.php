<div class="fixed inset-0 flex items-center justify-center z-50">
    ...
    <div class="modal-container bg-gray-800 w-1/12 md:w-2/5 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
        <div class="modal-header flex justify-between items-center p-4 border-b border-gray-700">
            <h5 class="modal-title text-white text-lg font-semibold">Crear Paquete Turístico</h5>
            ...
            <form wire:submit.prevent="create">
                ...
                <div class="mb-3">
                    ...
                    <select wire:model="estado" class="input input-bordered w-full p-2 rounded border border-gray-600 bg-gray-700 text-white" required>
                        ...
                        <option value="programado">Porgramado</option>
