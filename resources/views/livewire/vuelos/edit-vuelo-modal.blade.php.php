<div class="fixed inset-0 flex items-center justify-center z-50">
    ...
    <div class="modal-container bg-gray-800 w-11/12 md:w-2/5 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
        <div class="modal-header flex justify-between items-center p-4 border-b border-gray-700">
            <h5 class="modal-title text-white text-lg font-semibold">Editar Vuelo</h5>
        ...
        <div class="modal-body p-4">
            <form wire:submit.prevent="update">
                <div class="mb-3">
                    <label for="aerolinea" class="form-label text-white">Aerolínea</label>
                    <input type="text" wire:model="aerolinea" class="input input-bordered w-full p-2 rounded border border-gray-600 bg-gray-700 text-white" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" wire:model="fecha_salida" class="input input-bordered w-full p-2 rounded border border-gray-600 bg-gray-700 text-white" required>
                </div>
                <div class="mb-3">
                    <label for="fecha_llegada" class="form-label text-white">Fecha Llegada</label>
                    <input type="date" wire:model="fecha_llegada" class="input input-bordered w-full p-2 rounded border border-gray-600 bg-gray-700 text-white" required>
                </div>
                <div class="mb-3">
